...
const getNotificationsIR: any = {"usedParamSet":{"userId":true,"date":true},"params":[{"name":"userId","required":false,"transform":{"type":"scalar"},"locs":[{"a":44,"b":50}]},{"name":"date","required":true,"transform":{"type":"scalar"},"locs":[{"a":71,"b":76}]}],"statement":"SELECT *\nFROM notifications\nWHERE user_id = :userId\n  AND created_at > :date!"};
...
const thresholdFrogsIR: any = {"usedParamSet":{"numFrogs":true},"params":[{"name":"numFrogs","required":true,"transform":{"type":"scalar"},"locs":[{"a":147,"b":156}]}],"statement":"SELECT u.user_name, n.payload, n.type\nFROM notifications n\n  INNER JOIN users u on n.user_id = u.id\n  WHERE CAST (n.payload->'num_frogs' AS int) > :numFrogs!"};
