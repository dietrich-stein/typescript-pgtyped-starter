...
const findBookUnicodeIR: any = {"usedParamSet":{},"params":[],"statement":"SELECT *\nFROM books\nWHERE name = 'שקל'"};
...
const updateBooksCustomIR: any = {"usedParamSet":{"rank":true,"id":true},"params":[{"name":"rank","required":false,"transform":{"type":"scalar"},"locs":[{"a":43,"b":47},{"a":78,"b":82}]},{"name":"id","required":true,"transform":{"type":"scalar"},"locs":[{"a":123,"b":126}]}],"statement":"UPDATE books\nSET\n  rank = (\n    CASE WHEN (:rank::int IS NOT NULL)\n      THEN :rank\n      ELSE rank\n    END\n  )\nWHERE id = :id!"};
...
const updateBooksIR: any = {"usedParamSet":{"name":true,"rank":true,"id":true},"params":[{"name":"name","required":false,"transform":{"type":"scalar"},"locs":[{"a":26,"b":30}]},{"name":"rank","required":false,"transform":{"type":"scalar"},"locs":[{"a":42,"b":46}]},{"name":"id","required":true,"transform":{"type":"scalar"},"locs":[{"a":61,"b":64}]}],"statement":"UPDATE books\nSET\n  name = :name,\n  rank = :rank\nWHERE\n  id = :id!"};
...
const updateBooksRankNotNullIR: any = {"usedParamSet":{"rank":true,"name":true,"id":true},"params":[{"name":"rank","required":true,"transform":{"type":"scalar"},"locs":[{"a":26,"b":31}]},{"name":"name","required":false,"transform":{"type":"scalar"},"locs":[{"a":43,"b":47}]},{"name":"id","required":true,"transform":{"type":"scalar"},"locs":[{"a":60,"b":63}]}],"statement":"UPDATE books\nSET\n  rank = :rank!,\n  name = :name\nWHERE id = :id!"};
...
const getBooksByAuthorNameIR: any = {"usedParamSet":{"authorName":true},"params":[{"name":"authorName","required":true,"transform":{"type":"scalar"},"locs":[{"a":110,"b":121}]}],"statement":"SELECT b.*\nFROM books b\nINNER JOIN authors a ON a.id = b.author_id\nWHERE a.first_name || ' ' || a.last_name = :authorName!"};
...
const aggregateEmailsAndTestIR: any = {"usedParamSet":{"testAges":true},"params":[{"name":"testAges","required":false,"transform":{"type":"scalar"},"locs":[{"a":59,"b":67}]}],"statement":"SELECT\n  array_agg(email) as \"emails!\",\n  array_agg(age) = :testAges as ageTest\nFROM users"};
...
const getBooksIR: any = {"usedParamSet":{},"params":[],"statement":"SELECT\n  id,\n  name as \"name!\"\nFROM books"};
